      ...
      <header>
          ...
          <nav className="border-gray-200 bg-black">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <button onClick={() => { setMenuOpen(!menuOpen) }} data-collapse-toggle="navbar-dropdown" type="button" className="inline-flex items-center p-2 w-14 h-14 justify-center text-sm text-gray-500 rounded-lg lg:hidden focus:outline-none" aria-controls="navbar-dropdown" aria-expanded="false">
                ...
                <ul className="flex flex-col font-medium p-4 lg:p-0 mt-4 border border-gray-100 rounded-lg lg:space-x-8 rtl:space-x-reverse lg:flex-row lg:mt-0 lg:border-0">
                    ...
                    <li>
                        ...
                        <motion.div  id="dropdownResources" className="z-10 hidden font-normal bg-white divide-y divide-gray-100 shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] w-44 dark:divide-gray-600">
                            <ul className="py-2 text-sm text-black" aria-labelledby="dropdownLargeButton">
                                <li>
                    ...
                    <motion.li id='getintouch' onHoverStart={() => {animate("#git", { width: 10 })}} onHoverEnd={() => {animate("#git", { width: 0 })}}>
                        <Link  href='/get-in-touch' className="git flex items-center justify-between w-full py-2 px-3 text-white rounded lg:border-0 lg:p-0 lg:w-auto transition duration-500 fontedBebas mt-1">{t('main_menu_item_get_in_touch', { ns: 'common'})}</Link>
                        <svg  viewBox="0 0 10 0.2" fill="#FFF238">
                            <rect id='git' width="0" height="0.2"></rect>
                        </svg>
                    </motion.li>
                </ul>
                </div>
