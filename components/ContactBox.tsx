        ...
        <div className='grid sm:grid-cols-2 grid-cols-1'>
            <div className='sm:col-span-1 col-span-1 flex items-center p-6 px-12'>
                <h1 className='fontedBebas leading-none text-center w-full lg:my-10 my-0'>
                    <p className='lg:text-[124px] text-[62px] tracking-widest'><span className='text-[#FF7878]'>Get</span> <span className='text-[#B3C73E]'>in</span> <br/> <span className='text-[#78A6FF]'>touch</span></p>
                </h1>
            </div>
