        ...
        <div className=' w-full lg:h-full lg:py-0 py-10 grid lg:grid-cols-2 grid-cols-1'>
            ...
            <div className='lg:absolute lg:left-10 lg:bottom-4'>
                    <div className='w-[140px] lg:mx-0 mx-auto'>
                        <Link locale={props.locale} href={props.techStack == ServiceFlipBoxStack.MOBILE ? "/mobile-studio" : props.techStack == ServiceFlipBoxStack.SHOPIFY ? '/shopify-builders' : '/web3-studio'}><Button light={false}  title={t('service_offering_box_read_more', { ns: 'common'})}/></Link>
                    </div>
                </div>
