      ...
      <div id='hero' className='lg:px-40 px-10 my-10 w-full '>
                ...
                <div className='fontedBebas transition-all duration-500 opacity-50 hover:opacity-100'>
                    ...
                    <div className='relative w-full grid lg:grid-cols-6 grid-cols-1 lg:h-[200px]'>
                        ...
                        <div className='lg:col-span-3 col-span-1 w-full mt-4' style={{letterSpacing: '10px'}}>
                            <div className='w-full text-[#FF78B9] text-right pr-0 transition-all duration-500 lg:opacity-50 opacity-75 hover:opacity-100'>Design</div>
                            <div className='w-full text-[#78A6FF] text-right pr-4 transition-all duration-500 lg:opacity-50 opacity-75 hover:opacity-100'>Creation</div>
                            <div className='w-full text-[#6E6E6E] text-right pr-8 transition-all duration-500 lg:opacity-50 opacity-75 hover:opacity-100'>QA-Testing</div>
                            <div className='w-full text-[#8BC694] text-right pr-12 transition-all duration-500 lg:opacity-50 opacity-75 hover:opacity-100'>Launching</div>
                            <div className='w-full text-[#FF78B9] text-right pr-16 transition-all duration-500 lg:opacity-50 opacity-75 hover:opacity-100'>Maintenance</div>
                        </div>
                ...
                <div className='fontedBebas transition-all duration-500 opacity-50 hover:opacity-100 border-dashed border-t-[2px] border-gray-800'>
                    ...
                    <div className='relative w-full grid lg:grid-cols-6 grid-cols-1 lg:h-[200px]'>
                        ...
                        <div className='lg:col-span-3 col-span-1 w-full mt-4 text-[24px] leading-[40px] mt-[40px]' style={{letterSpacing: '10px'}}>
                            <div className='w-full text-[#FF78B9] text-right pr-0 transition-all duration-500 lg:opacity-50 opacity-75 hover:opacity-100'>Wireframes</div>
                            <div className='w-full text-[#78A6FF] text-right pr-4 transition-all duration-500 lg:opacity-50 opacity-75 hover:opacity-100'>Brand Identity</div>
                            <div className='w-full text-[#6E6E6E] text-right pr-0 transition-all duration-500 lg:opacity-50 opacity-75 hover:opacity-100'>Prototyping</div>
                        </div>
        ...
        <div className='fontedBebas w-full grid lg:grid-cols-2 grid-cols-1 lg:h-[300px] border-dashed border-t-[2px] border-gray-800'>
            <div className='relative col-span-1 border-dashed lg:border-r-[2px] border-gray-800 transition-all duration-500 opacity-50 hover:opacity-100'>
                <h2>e-Commerce</h2>
                <h2 className='lg:leading-[100px] leading-[60px] opacity-75 lg:text-[72px] text-[56px] drop-shadow-[4px_4px_rgba(255,242,56,1)]' style={{letterSpacing: '20px'}}><span className='text-black'>Shopify</span></h2>
                <div className='w-full text-[#FF78B9] text-left transition-all duration-500 lg:opacity-50 opacity-75 hover:opacity-100'><span className='text-[#78A6FF]'>Template</span> <span className=''>Design</span></div>
                <div className='w-full text-[#FF78B9] text-left transition-all duration-500 lg:opacity-50 opacity-75 hover:opacity-100'> <span className='text-[#8BC694]'>Marketplaces</span></div>
                <div className='w-full text-[#FF78B9] text-left transition-all duration-500 lg:opacity-50 opacity-75 hover:opacity-100'> <span className='text-[#FF7878]'>Shopify Apps</span></div>
            ...
            <div className='relative col-span-1 border-dashed lg:border-t-[0px] border-t-[2px] border-gray-800 lg:text-right text-left transition-all duration-500 opacity-50 hover:opacity-100'>
                ...
                <div className='w-full text-[#FF78B9] lg:text-right text-left transition-all duration-500 lg:opacity-50 opacity-75 hover:opacity-100'> <span className='text-[#FF7878]'>Web</span> <span className='text-[#FF78B9]'> Development</span></div>
                <div className='w-full text-[#FF78B9] lg:text-right text-left transition-all duration-500 lg:opacity-50 opacity-75 hover:opacity-100'> <span className='text-[#B3C73E]'>NFT</span> <span className='text-black]'>Generation</span></div>
